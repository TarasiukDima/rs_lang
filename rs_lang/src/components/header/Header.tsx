            ...
            <div className="wrapper">
                ...
                <nav className="header__nav">
                    <ul className="nav__list">
                        {pages.map((pageObj) => (
                            <li
                                key={pageObj.textLink}
                                className="nav__list_item"
                            >
                                <Link to={pageObj.link}>
                                    {pageObj.textLink}
                                </Link>
                            </li>
                        ))}
