...
export const changeVocabularyCategory: TSimpleActionFC<number> = (numberTab: number): IAction => {
    return {
        type: CHANGE_VOCABULARY_CATEGORY,
        payload: numberTab
    };
}
export const changeVocabularyPage: TSimpleActionFC<number> = (numberPage: number): IAction => {
    return {
