...
import { IWordItemObj, TSoundButtonClick } from "../../types/book";
import { ITabInfoObj, TTabClickFC } from "../../types/common";
import "./index.scss";
...
const BookPage = () => {
    ...
    const tabsInfo: Array<ITabInfoObj> = [
        { id: 1 },
        { id: 2 },
        { id: 3 },
        { id: 4 },
    ...
    const bookListInfoArr: Array<IWordItemObj> = [
        {
        ...
        },
        {
            ...
            textMeaning:
                "A <i>camera</i> is a piece of equipment that takes pictures.",
        ...
        },
        {
            ...
            textMeaningTranslate:
                "Поймать - значит схватить или получить что-то",
        ...
        },
        {
            ...
            textExample:
                "I will <b>invite</b> my friends to my birthday party.",
            transcription: "[inváit]",
            textExampleTranslate:
                "Я приглашаю своих друзей на мой день рождения",
            textMeaningTranslate:
        ...
        },
        {
            ...
            textMeaning:
                "To <i>love</i> is to like something or someone a lot.",
            textExample: "I <b>love</b> my family very much.",
            transcription: "[lʌv]",
            textExampleTranslate: "Я очень люблю свою семью",
            textMeaningTranslate:
                "Любить значит любить что-то или кого-то много",
        ...
        },
        {
            ...
            textMeaning:
                "A <i>week</i> is a period of time that is seven days long.",
    ...
    const clickButton: TSoundButtonClick = (
        audio,
        audioMeaning,
        audioExample
    ) => {
        console.log(audio, audioMeaning, audioExample);
    };
    ...
    return (
        <SectionContent nameClass="book__section">
            ...
            <WordsList
                bookListInfoArr={bookListInfoArr}
